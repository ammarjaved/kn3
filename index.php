...
<script>
    var language;
    var language_type;
    var selected_lang_global='<?php if(isset($_GET['lang'])){echo $_GET['lang'];}else{echo 'en';} ?>';
    ...
    function setLanguage(lang) {
        var selected_lang='<?php if(isset($_GET['lang'])){echo $_GET['lang'];}else{echo 'en';} ?>';
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <div class="navbar-nav">
                                <div>
                                    ...
                                    <span id="en" class="label" title="English"> E</span>
            ...
            <div class="languageDiv_375">
                <div class="navbar-nav">
                    <div class="navbar_nav_sub_375">
                        <span id="arb" style="border-right: 1px solid snow; padding-right: 7px;cursor:pointer; " class="label" title="عربى ">ع</span>
                        <span id="en" style="border-right: 1px solid snow; padding-right: 7px;cursor:pointer; " class="label" title="English"> E</span>
                        <span id="heb" class="label" style="cursor:pointer;" title="עברית"> ע</span>
                    </div>
                </div>
            </div>
        ...
        <div id="sidebar-container-symbology" class="sidebar-container sidebar-container-left" style="border-radius: 5px">
            <div class="sidebar-content row">
                <div class=" col-md-12 col-sm-4">
                    <ul class="list-group list-group-flush customCssForLi" style="padding-top: 10px;padding-left: 5px;" id="myUL">
                            ...
                            <ul class="nested active" style="height:35px">
                                <li style="">
                                    <label class="customCheckBox customCheckBoxPink">
                                        <input class="form-check-input" type="checkbox" id="demolitions" onclick="addAndRemoveLayer(demolitions,'demolitions')" value="A&B">
                                        <span class="checkmark checkmarkLeftUpper" style="">
                                            <i class="fas fa-check" id="fa-demolitions"></i>
                                        </span>
                                        <h6 id="demolitions1" style="font-family: inherit;font-size:12px;" class="form-check-label">
                                            <label class="leftPanelTitleCss" style="float:left;" for="demolitions" data-translate="Area_B_Demolities">Area B
                                                Demolitions
                                            </label>
                                        </h6>
                                    </label>
                            ...
                            <ul class="nested active" style="height:35px">
                                <li>
                                    <label class="customCheckBox customCheckBoxYellow">
                                        <input class="form-check-input" type="checkbox" id="area_b_training" onclick="addAndRemoveLayer(area_b_training,'area_b_training')" value="A&B">
                                        <span class="checkmark checkmarkLeftUpper" style="">
                                            <i class="fas fa-check" id="fa-area_b_training"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;" id="area_b_training1" class="form-check-label">
                                            <label class="leftPanelTitleCss" style="float:left;" for="area_b_training" data-translate="training">Area B
                                                Training
                                            </label>
                                        </h6>
                                    </label>
                            ...
                            <ul class="nested active" style="height:35px">
                                <li>
                                    <label class="customCheckBox customCheckBoxOrange">
                                        <input class="form-check-input" type="checkbox" id="security_orders" onclick="addAndRemoveLayer(security_orders,'security_orders')" value="A&B">
                                        <span class="checkmark checkmarkLeftUpper" style="">
                                            <i class="fas fa-check" id="fa-security_orders"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;" id="security_orders1" class="form-check-label">
                                            <label class="leftPanelTitleCss" style="float:left;" for="security_orders" data-translate="Security_Measures">Security
                                                Orders
                                            </label>
                                        </h6>
                                    </label>
                        ...
                        <li class="list-group-item left-bottom-sidebar col-md-12 col-sm-4" style="border-bottom: none;">
                            <ul class="nested active">
                                <li>
                                    <label class="customCheckBox customCheckBoxOrange">
                                        <h6 class="form-check-label" style="float:left;" id="no_construction_orders1">
                                            <label class="leftPanelTitleCss" style="float:left;" for="No_Construction_Order" data-translate="No_Construction_Order">No Construction Orders
                                            </label></h6>
                                    </label>
                                    <label class="customCheckBox customCheckBoxBlue" style="display: inline-block;margin-bottom: 0px;">
                                        <input class="form-check-input" type="checkbox" id="no_construction_orders" onclick="addAndRemoveLayer(no_construction_orders,'no_construction_orders')" value="A&B">
                                        <span class="checkmark checkmarkLeft checkmarkLeft1" style="top: -6px;">
                                            <i class="fas fa-check" id="fa-no_construction_orders"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;display: inline-block;" class="form-check-label">
                                            <b data-translate="araa_a_area_b" style="color: rgba(94,94,94,1);" class="araa_a_area_b">Area A & Area
                                                B
                                            </b>
                                        </h6>
                                    </label>
                                    <label class="customCheckBox customCheckBoxPurple" style="display: inline-block;margin-bottom: 0px;">
                                        <input class="form-check-input" type="checkbox" id="no_construction_order_not_ab" onclick="addAndRemoveLayer(no_construction_order_not_ab,'no_construction_order_not_ab')" value="A&B">
                                        <span class="checkmark checkmarkLeft checkmarkLeft_375" style="top: -13px;left: 30px;">
                                            <i class="fas fa-check" id="fa-no_construction_order_not_ab"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;" class="form-check-label">
                                            <b data-translate="AreaC" style="color: rgba(94,94,94,1);" class="AreaC">Area C</b>
                                        </h6>
                                    </label>
                                </li>
                            </ul>
                        ...
                        <li class="list-group-item col-md-12 col-sm-4">
                            <ul class="nested active">
                                <li>
                                    <label class="customCheckBox customCheckBoxOrange">
                                        <h6 class="form-check-label" style="float:left;" id="expropriation_orders_ab1">
                                            <label class="leftPanelTitleCss" style="float:left;" for="No_Construction_Order" data-translate="Expropriation_Orders">Expropriation Orders
                                            </label></h6>
                                    </label>

                                    <label class="customCheckBox customCheckBoxGolden" style="display: inline-block;margin-bottom: 0px;">
                                        <input class="form-check-input" type="checkbox" id="expropriation_orders_ab" onclick="addAndRemoveLayer(expropriation_orders_ab,'expropriation_orders_ab')" value="A&B">
                                        <span class="checkmark checkmarkLeft checkmarkLeft1" style="top: -6px;">
                                            <i class="fas fa-check" id="fa-expropriation_orders_ab"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;margin-top: 10px" class="form-check-label">
                                            <b data-translate="araa_a_area_b" style="color: rgba(94,94,94,1);" class="araa_a_area_b">Area A & Area
                                                B
                                            </b>
                                        </h6>
                                    </label>
                                    <label class="customCheckBox customCheckBoxGoldenLi" style="display: inline-block;margin-bottom: 0px;">
                                        <input class="form-check-input" type="checkbox" id="expropriation_orders" onclick="addAndRemoveLayer(expropriation_orders,'expropriation_orders')" value="A&B">
                                        <span class="checkmark checkmarkLeft checkmarkLeft_375" style="top: -13px; left: 30px;">
                                            <i class="fas fa-check" id="fa-expropriation_orders"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;" class="form-check-label">
                                            <b data-translate="AreaC" style="color: rgba(94,94,94,1);" class="AreaC">Area C</b></h6>
                                    </label>
                                </li>
                            </ul>
                        </li>

                        <li class="list-group-item col-md-12 col-sm-4" style="border-radius: 5px">
                            <ul class="nested active">
                                <li>
                                    <label class="customCheckBox customCheckBoxOrange">
                                        <h6 class="form-check-label" style="float:left;" id="seizure1">
                                            <label class="leftPanelTitleCss" style="float:left;" for="Seizure" data-translate="Seizure">Seizures Area
                                            </label></h6>
                                    </label>

                                    <label class="customCheckBox customCheckBoxBrown" style="display: inline-block;margin-bottom: 0px;">
                                        <input class="form-check-input" type="checkbox" id="seizure" onclick="addAndRemoveLayer(seizure,'seizure')" value="A&B">
                                        <span class="checkmark checkmarkLeft checkmarkLeft1" style="top: -6px">
                                    ...
                                    <label class="customCheckBox customCheckBoxBrownLi" style="display: inline-block;margin-bottom: 0px;">
                                        <input class="form-check-input" type="checkbox" id="seizure_ab" onclick="addAndRemoveLayer(seizure_ab,'seizure_ab')" value="A&B">
                                        <span class="checkmark checkmarkLeft checkmarkLeft_375" style="top: -16px; left: 30px;">
                                            <i class="fas fa-check" id="fa-seizure_ab"></i>
                                        </span>
                                        <h6 style="font-family: inherit;font-size:12px;" class="form-check-label">
                                            <b data-translate="AreaC" style="color: rgba(94,94,94,1);" class="AreaC">Area C</b>
                                        </h6>
            ...
            <div class="sidebar-toggler-btn rotated-text d-flex align-items-center justify-content-center polygons" style="display: none !important;border-radius: 5px">
                ...
                <div class="modal-body" style="height: 600px;overflow-y: scroll;background-color: transparent;">
                    <div class="row" style="">
                        <div class="col-md-3" style="float: right !important;">
                            <a href="https://www.keremnavot.org/"><img src="assets/img/KeremLogoWhite.png" width="200px" height="200px" /></a>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12" style="">
                                <p style="text-align: right; " class="text-justify text-justify directionText" data-translate="p1">בנובמבר 1991 התקיימה ועידת שלום במדריד, ובעקבותיה נפתח באוסלו ערוץ
...
<!--            <span>i</span>-->
        ...
        <div id="sidebar-container-layers" class="sidebar-container sidebar-container-right" style="border-radius: 5px">
            ...
            <div style="margin-top: -52px;" class="sidebar-toggler-btn rotated-text d-flex align-items-center justify-content-center layers">
                <span data-translate="Layers" class="customeFontSze">Layers</span>
            </div>
        </div>


        <div class="modal rightModel fade " id="" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="modal-body" style="height: 600px;overflow-y: scroll;background-color: transparent;">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12 " style="">
                                    <p style="text-align: right; " class="text-justify directionText" data-translate="p1">בנובמבר 1991 התקיימה ועידת שלום במדריד, ובעקבותיה נפתח באוסלו
                                        ערוץ
        ...
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0" nonce="em0Iq2cN"></script>

    </section>
    <div class="special-modal portfolio-modal modal fade" id="philosophyVideo" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal" onclick="philosophy_player.stopVideo();philosophy_player.destroy();"><img
...
<script>
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            $('.typeahead').typeahead({
                name: 'hce',
                remote: 'http://3.17.36.216/kn_api/search/eng/%QUERY',
                highlight: true,
                limit: 5
            });
    ...
    $("#body").css("background-color", "transparent")
        if (language_type == 'en') {
            $("#body").css("font-family", "myEnglishFont");
    ...
    function search() {
        ...
        $.ajax({
            url: "http://3.17.36.216/kn_api/search_result/eng/" + sr,
            type: 'GET',
