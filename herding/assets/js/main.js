...
var server_url = "http://18.224.27.72/herding/";
...
var seizure_ab = "";
var demolitions = "";
var area_controlled_by_settlers = "";
var area_controlled_by_settlers2025 = "";
var tbl_palestinian_herding_communities = "";
var tbl_settler_cattle_enclosures = "";
var wzo_allocations = "";
var outposts_pre_2022 = "";
var outposts_post_2022 = "";
var area_b_training = "";
var security_orders = "";
var violation1;
var doa = 0;
...
var road_c = 0;
var setl = 0;
var count_outposts_pre_2022 = 0;
var count_outposts_post_2022 = 0;
var count_tbl_palestinian_herding_communities = 0;
var count_tbl_settler_cattle_enclosures = 0;
var violation2;
var wmsLayers = [];
var baseLayers;
var ytube_layer;
var geoserver_config = {
  url: "http://3.17.36.216:8080/geoserver/",
  namespace: "simca",
};
var poi_cluster_obj = {
...
var data_config_right = {
  ...
  area_b_violations: {
    ...
    trans_name: "AreaB",
    type: "area_b_violations_clusters",
    url: "http://18.224.27.72/herding/kn_api/herding_outpost",
    geojson_options: {
      ...
      onEachFeature: function (feature, layer) {
        ...
        if (language_type == "en") {
          ...
          var year_established =
            properties.year_established == null
              ? " "
              : properties.year_established;
        ...
        if (language_type == "en") {
          if (
            ...
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-3.png",
                iconSize: [24, 28],
                iconAnchor: [12, 28],
                popupAnchor: [0, -25],
              }),
            ...
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-1.png",
                iconSize: [24, 28],
                iconAnchor: [12, 28],
                popupAnchor: [0, -25],
              }),
            ...
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-2.png",
                iconSize: [24, 28],
                iconAnchor: [12, 28],
                popupAnchor: [0, -25],
              }),
          ...
          if (
            feature.properties.classfication_hebrew == "מאחז בת - שלוחה של מאחז"
          ) {
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-3.png",
          ...
          } else if (feature.properties.classfication_hebrew == "מאחזי רועים") {
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-1.png",
                iconSize: [24, 28],
          ...
          } else if (feature.properties.classfication_hebrew == "מאחזי חוות") {
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-2.png",
                iconSize: [24, 28],
    ...
    wms: {
      ...
      gwc_url:
        geoserver_config.url + geoserver_config.namespace + "/gwc/service/wms",
      wms_options: {
  ...
  /*tbl_declared_state_land*/
  area_b_training: {
    name: "Training",
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_declared_state_land",
    /*geojson_options: {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    pane: "right_layers",
  ...
  security_orders: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_tabu_state_land",
    /*geojson_options: {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    pane: "right_layers",
    ...
    geojson_options: {
      ...
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
          "<table><tr><td>" + language.Security_Measures + "</td></tr></table>",
          {}
        );
      },
      style: {
  ...
  area_b_demolitions: {
    ...
    trans_name: "AreaB",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_firing_zone",
  ...
  tbl_expropriation_orders_ab: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/expropriation_orders_ab",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_expropriation_orders: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/expropriation_orders",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_no_construction_order: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_nature_reserve",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_no_construction_order_not_ab: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/no_construction_order_not_ab",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_herding_outpost: {
    ...
    geojson_options: {
      ...
      pointToLayer: function (feature, latlng) {
        if (language_type == "en") {
          if (feature.properties.classfication_english == "Herding Outpost 1") {
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-3.png",
                iconSize: [24, 28],
            ...
            feature.properties.classfication_english == "Herding Outpost 2"
          ) {
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-1.png",
            ...
            feature.properties.classfication_english == "Herding Outpost 3"
          ) {
            return L.marker(latlng, {
              icon: L.icon({
                iconUrl: "assets/img/r-lyr-2.png",
              ...
              riseOnHover: true,
                        ...
                        feature.properties.classfication_english == "Herding Outpost 4"
                    ) {
                        return L.marker(latlng, {
                            icon: L.icon({
                                iconUrl: "assets/img/material-group.png",
  ...
  area_controlled_by_settlers: {
    name: language.violation_class4,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_hearding_farms_zones",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
          "<table><tr><td>" +
            language.violation_class4_popup +
            ": " +
  ...
  area_controlled_by_settlers2025: {
    name: language.violation_class5,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_area_controlled_settlers_2022",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
          "<table><tr><td>" +
            language.violation_class5_popup +
            ": " +
            layer.feature.properties.area +
            "</td></tr></table>",
          {}
  ...
  wzo_allocations: {
    name: language.allocations,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_wzo_allocations",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        if (currentLanguage == "en") {
          layer.bindPopup(
            "<table><tr><td>" +
              language.allocations_popup +
              ": " +
              layer.feature.properties.name_english +
              "</td></tr></table>",
            {}
          );
          ...
          layer.bindPopup(
            "<table><tr><td>" +
              language.allocations_popup +
              ": " +
              layer.feature.properties.name_arabic +
              "</td></tr></table>",
            {}
          );
        } else {
          layer.bindPopup(
            "<table><tr><td>" +
              language.allocations_popup +
              ": " +
              layer.feature.properties.name_hebrew +
              "</td></tr></table>",
            {}
          );
        }
  ...
  outposts_post_2022: {
    name: language.violation_class6,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/herding_outpost_post_2022",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        if (currentLanguage == "en") {
          layer.bindPopup(
            "<table><tr><td>" +
              language.violation_class6_popup +
              ": " +
              layer.feature.properties.name_english +
              "</td></tr></table>",
            {}
  ...
  outposts_pre_2022: {
    name: language.violation_class7,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/herding_outpost",
    geojson_options: {
      onEachFeature: function (feature, layer) {
        if (currentLanguage == "en") {
          layer.bindPopup(
            "<table><tr><td>" +
              language.violation_class7_popup +
              ": " +
              layer.feature.properties.name_english +
              "</td></tr></table>",
            {}
  ...
  tbl_palestinian_herding_communities: {
    name: language.violation_class8,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_palestinian_herding_communities",
    geojson_options: {
      onEachFeature: function (feature, layer) {
        if (currentLanguage == "en") {
          layer.bindPopup(
            "<table><tr><td>" +
              language.violation_class8_popup +
              ": " +
              layer.feature.properties.name_english +
              "</td></tr></table>",
            {}
      ...
      pointToLayer: function (feature, latlng) {
        count_tbl_palestinian_herding_communities++;
        return L.circleMarker(latlng, {
          pane: "right_layers",
          radius: 5,
          fillColor: "#28b463",
  ...
  tbl_settler_cattle_enclosures: {
    name: language.violation_class9,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/tbl_settler_cattle_enclosures",
    geojson_options: {
      onEachFeature: function (feature, layer) {},
      pointToLayer: function (feature, latlng) {
        count_tbl_settler_cattle_enclosures++;
        return L.circleMarker(latlng, {
          pane: "right_layers",
          radius: 5,
          fillColor: "#3498db",
  ...
  tbl_babachy_israeli: {
    name: language.babachy_israeli,
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://18.224.27.72/herding/kn_api/babachy_israeli",
    geojson_options: {
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
          "<table><tr><td>" + language.babachy_israeli + "</td></tr></table>",
          {}
        );
      },
      pointToLayer: function (feature, latlng) {
...
var basemaps = [
  ...
  L.tileLayer(
    ...
    {
      attribution:
        '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> &copy; <a href="http://cartodb.com/attributions">CartoDB</a> | Map Authored by <a href="https://bazini627.github.io/" target="blank">Matthew Bacinskas</a> | <a href="https://getbounds.com">Malcolm Meyer</a>',
      subdomains: "abcd",
    }
  ),
...
function add_right_layers() {
  Object.keys(data_config_right).forEach(function (key, i) {
    ...
    if (lyr_config.type === "area_b_violations_clusters") {
...
function load_geojson_layer_left(
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      if (lyr_key == "tbl_herding_outpost") {
        seizure = L.geoJSON(res, lyr_config.geojson_options);
      }
      if (lyr_key == "tbl_babachy_israeli") {
        babachy_israeli = L.geoJSON(res, lyr_config.geojson_options);
      }
      ...
      if (lyr_key == "area_controlled_by_settlers") {
        area_controlled_by_settlers = L.geoJSON(
          res,
          lyr_config.geojson_options
        );
        violation4 = L.geoJSON(res, lyr_config.geojson_options);
      }
      if (lyr_key == "area_controlled_by_settlers2025") {
        area_controlled_by_settlers2025 = L.geoJSON(
          res,
          lyr_config.geojson_options
        );
        violation5 = L.geoJSON(res, lyr_config.geojson_options);
      }
      if (lyr_key == "wzo_allocations") {
        wzo_allocations = L.geoJSON(res, lyr_config.geojson_options);
        allocations = L.geoJSON(res, lyr_config.geojson_options);
      }

      if (lyr_key == "outposts_post_2022") {
        outpostspost2022 = L.geoJSON(res, lyr_config.geojson_options);
        outposts_post_2022 = L.geoJSON(
          res,
          lyr_config.geojson_options,
          setTimeout(function () {
            $("#checkmarkNoViolation6").append(
              '<span style="position: absolute;' +
                'padding: 4px 0px 0px 8px;" class="badge badge-danger" style="">' +
                count_outposts_post_2022 / 2 +
                "</span>"
            );
          }, 3000)
        );
      ...
      if (lyr_key == "outposts_pre_2022") {
        outpostspre2022 = L.geoJSON(res, lyr_config.geojson_options);
        outposts_pre_2022 = L.geoJSON(
          res,
          lyr_config.geojson_options,
          setTimeout(function () {
            $("#checkmarkNoViolation7").append(
              '<span style="position: absolute;' +
                'padding: 4px 0px 0px 8px;" class="badge badge-danger" style="">' +
                count_outposts_pre_2022 / 2 +
                "</span>"
            );
          }, 3000)
        );
      }
      if (lyr_key == "tbl_palestinian_herding_communities") {
        palestinian_herding_communities = L.geoJSON(
          res,
          lyr_config.geojson_options
        );
        tbl_palestinian_herding_communities = L.geoJSON(
          res,
          lyr_config.geojson_options,
          setTimeout(function () {
            $("#checkmarkNoViolation8").append(
              '<span style="position: absolute;' +
                'padding: 4px 0px 0px 8px;" class="badge badge-danger" style="">' +
                count_tbl_palestinian_herding_communities / 2 +
                "</span>"
            );
          }, 3000)
        );
      }
      if (lyr_key == "tbl_settler_cattle_enclosures") {
        settler_cattle_enclosures = L.geoJSON(res, lyr_config.geojson_options);
        tbl_settler_cattle_enclosures = L.geoJSON(
          res,
          lyr_config.geojson_options,
          setTimeout(function () {
            $("#checkmarkNoViolation9").append(
              '<span style="position: absolute;' +
                'padding: 4px 0px 0px 8px;" class="badge badge-danger" style="">' +
                count_tbl_settler_cattle_enclosures / 2 +
                "</span>"
            );
          }, 3000)
        );
      ...
      violation1 = L.geoJson(res, {
        onEachFeature: function (feature, layer) {
          ...
          if (language_type == "en") {
            ...
            var link2 = properties.art_eng == null ? " " : properties.art_eng;
            var titt_eng =
              properties.titt_eng == null ? " " : properties.titt_eng;
            var desc_eng =
              properties.desc_eng == null ? " " : properties.desc_eng;
            var str =
              ...
              "<br />" +
              "<b>" +
              language.outpost_name +
              "</b>: " +
              titt_eng +
              "<br />" +
              "<b>" +
              language.year_established +
              "</b>: " +
              year_established +
              "<br />" +
              "<b>" +
              ...
              "</div>";
            $.ajax({
              url: "/herding/getimages.php?id=" + properties.picture_id,
              type: "GET",
              success: function (res) {
                var images = JSON.parse(res);
                if (images.length > 0) {
                  str = str + '<div class="popupcontentDiv">';

                  // '<div class="popupprev"><a class="prev" onclick="plusSlides(-1)">&#10094;</a></div>';
                }
                str =
                  str +
                  '<div class="popuptwitterDiv" style="display: none;">' +
                  '<div class="popuptwittersubDiv">' +
                  '<div class="col-md-12 leaflet-popup-content-fb">' +
                  '<div class="fb-share-button" data-href="http://18.224.27.72/herding/index.php?' +
                  "lat=" +
                  layer._latlng.lat +
                  "&lng=" +
                  layer._latlng.lng +
                  "&fid=" +
                  properties.photoid +
                  '" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://18.224.27.72/herding/index.php?' +
                  "lat=" +
                  layer._latlng.lat +
                  "&lng=" +
                  layer._latlng.lng +
                ...
                if (images.length > 0) {
                  ...
                  str =
                    str + "</div><br />" + '<div style="text-align:center">';
                ...
                var twitter_url = encodeURIComponent(
                  "http://18.224.27.72/herding/index.php?" +
                    "lat=" +
                    layer._latlng.lat +
                    "&lng=" +
                    layer._latlng.lng +
                ...
                var html =
                  ...
                  "</div>" +
                  "</div>" +
                  ' <h4 style="text-align: center;margin-bottom: 0px!important;background-color: #C32F27;color:snow;border-radius: 5px 5px 0px 0px;">' +
                ...
                // '<tr><td>Affected Palestinian Community</td><td>N/A</td></tr>' +
                // '<tr><td>URL</td><td>http://18.224.27.72/index.php?lat='+layer._latlng.lat+'&lng='+layer._latlng.lng+'&fid='+properties.fid+'</td></tr>' +
                // '</table>';
                // </div>';
          ...
          if (language_type == "arb") {
            ...
            var link2 = properties.art_arb == null ? " " : properties.art_arb;
            var titt_arb =
              properties.titt_arb == null ? " " : properties.titt_arb;
            var desc_arb =
              properties.desc_arb == null ? " " : properties.desc_arb;
            var year_established =
              properties.year_established == null
                ? " "
                : properties.year_established;
            var str =
              '<div style="min-width: 300px;max-width: none;padding-bottom:0px;" class="container-fluid">' +
              '<div class="col-md-12 container-fluid-title-div" style="">' +
              "<p>" +
              category_arabic +
              "<br />" +
              "<b>" +
          ...
          if (language_type == "heb") {
            ...
            var link2 = properties.art_heb == null ? " " : properties.art_heb;
            var titt_heb =
              properties.titt_heb == null ? " " : properties.titt_heb;
            var desc_heb =
              properties.desc_heb == null ? " " : properties.desc_heb;
            var year_established =
              properties.year_established == null
                ? " "
                : properties.year_established;
            var str =
              '<div style="min-width: 300px;max-width: none;padding-bottom:0px;" class="container-fluid">' +
              '<div style="" class="col-md-12 container-fluid-title-div">' +
              "<p>" +
              category_hebrew +
              "<br />" +
              "<b>" +
      ...
      violation2 = L.geoJson(res, {
        onEachFeature: function (feature, layer) {
          ...
          if (language_type == "arb") {
            ...
            var str =
              '<div style="min-width: 300px;max-width: none;padding-bottom:0px" class="container-fluid">' +
              '<di style="" class="col-md-12 container-fluid-title-div">' +
              "<p>" +
              category_arabic +
              "<br />" +
              "<b>" +
      ...
      violation3 = L.geoJson(res, {
        onEachFeature: function (feature, layer) {
          ...
          if (language_type == "en") {
            ...
            var link5 = properties.art_eng == null ? " " : properties.art_eng;
            var titt_eng =
              properties.titt_eng == null ? " " : properties.titt_eng;
            var desc_eng =
              properties.desc_eng == null ? " " : properties.desc_eng;
            ...
            $.ajax({
              ...
              success: function (res) {
                ...
                var html =
                  ...
                  '<div  class="popuptwittersubDiv">' +
                  '<div class="col-md-12">' +
                  '<div class="fb-share-button leaflet-popup-content-fb" data-href="http://18.224.27.72/herding/index.php?' +
                  "lat=" +
                  layer._latlng.lat +
                  "&lng=" +
                  layer._latlng.lng +
      ...
      /*violation4 = L.geoJson(res, {
                onEachFeature: function (feature, layer) {
                    ...
                    if (language_type == "en") {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                str =
                                    str + '<div class="popuptwitterDiv" style="display: none;">' +
                                    '<div class="popuptwittersubDiv">' +
                                    '<div class="col-md-3 leaflet-popup-content-fb">' +
                                    '<div class="fb-share-button" data-href="http://18.224.27.72/kn/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                                    "&fid=" +
                                    properties.fid +
                                    '" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://18.224.27.72/kn/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                                ...
                                var twitter_url = encodeURIComponent(
                                    "http://18.224.27.72/kn/index.php?" +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                    ...
                    if (language_type == "arb") {
                        ...
                        $.ajax({
                            url: "/kn/getimages.php?id=" + properties.picture_id,
                            type: "GET",
                            success: function (res) {
                                var images = JSON.parse(res);
                                if (images.length > 0) {
...
function load_vector_grid_from_geojson(
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      if (
        lyr_key == "tbl_herding_outpost" ||
        lyr_key == "tbl_babachy_israeli" ||
        ...
        lyr_key == "area_controlled_by_settlers" ||
        lyr_key == "area_controlled_by_settlers2025" ||
        lyr_key == "wzo_allocations" ||
        lyr_key == "outposts_pre_2022" ||
        lyr_key == "outposts_post_2022" ||
        lyr_key == "tbl_palestinian_herding_communities" ||
        lyr_key == "tbl_settler_cattle_enclosures"
      ) {
      } else {
        if (lyr_key == "Palestinian_Localities_WestBank") {
          groupedOverlays.POI[
      ...
      if (generate_ui) {
        var html_lyr_config_obj = {
          ...
          trans_name: lyr_config.trans_name,
          opacity:
            lyr_config.vg.options.vectorTileLayerStyles.sliced.fillOpacity,
        };
        generate_layer_html(html_lyr_config_obj, lyr_key, lyr);
      }
      if (is_last) {
...
function generate_layer_html(lyr_config, lyr_key, lyr) {
  ...
  if (
    ...
    if (lyr_key == "tbl_herding_outpost") {
      ...
      html =
        '<div data-lyr-key="tbl_herding_outpost,tbl_seizure_ab,outposts_post_2022,tbl_settler_cattle_enclosures,tbl_palestinian_herding_communities,outposts_pre_2022,wzo_allocations,area_controlled_by_settlers2025,area_controlled_by_settlers" class="layer-box mb-2 d-flex flex-column align-items-center justify-content-between"><div class="d-flex justify-content-between w-100"><div class="layer-box-right d-flex align-items-center"><span class="layer-toggler active"></span><span class="layer-title" data-translate="' +
    ...
    var html =
      ...
      '<div class="row rightPanelRow">' +
      //Item 1
      '<div class="col-md-12" >' + //border-bottom: 1px solid rgba(0,0,0,.125);
      '<div class="row rightPanelRow">' +
      '<div id="violation12" class="col-md-3 centerIcon">' +
      '<label class="customCheckBoxRightPickupOrange customCheckBoxRight"><input class="form-check-input" type="checkbox" onclick=addAndRemoveLayer(outpostspre2022,"outpostspre2022") id="outpostspre2022"  value=""><span class="checkmarkNo checkmark-margin vertical-center-icon" id="checkmarkNoViolation7"></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class7" id="vc2">' +
      language.violation_class7 +
      "</p>" +
      "</div>" +
      ...
      '<div class="row rightPanelRow">' +
      '<div id="violation12" class="col-md-3 centerIcon">' +
      '<label class="customCheckBoxRightPickupRed customCheckBoxRight"><input class="form-check-input" type="checkbox" onclick=addAndRemoveLayer(outpostspost2022,"outpostspost2022") id="outpostspost2022" value=""><span class="checkmarkNo checkmark-margin vertical-center-icon" id="checkmarkNoViolation6"></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class6" id="vc2">' +
      language.violation_class6 +
      "</p>" +
      "</div>" +
      '<div id="violation12Tooltip" class="col-md-2"  style="position:absolute;left:0">' +
      "</div>" +
      ...
      '<div class="row rightPanelRow">' +
      '<div id="violation12" class="col-md-3 centerIcon">' +
      '<label class="customCheckBoxRightPickupBlue customCheckBoxRight"><input class="form-check-input" type="checkbox" onclick=addAndRemoveLayer(settler_cattle_enclosures,"settler_cattle_enclosures") id="settler_cattle_enclosures" value=""><span class="checkmarkNo checkmark-margin vertical-center-icon" id="checkmarkNoViolation9"></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class9" id="vc2">' +
      language.violation_class9 +
      "</p>" +
      "</div>" +
      "</div>" +
      "</div>" +
      ...
      '<div class="row rightPanelRow">' +
      '<div id="violation12" class="col-md-3 centerIcon">' +
      '<label class="customCheckBoxRightPickupGreen customCheckBoxRight"><input class="form-check-input" type="checkbox" onclick=addAndRemoveLayer(tbl_palestinian_herding_communities,"tbl_palestinian_herding_communities") id="tbl_palestinian_herding_communities"  value=""><span class="checkmarkNo checkmark-margin vertical-center-icon" id="checkmarkNoViolation8"></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class8" id="vc2">' +
      language.violation_class8 +
      "</p>" +
      "</div>" +
      '<div id="violation12Tooltip" class="col-md-2"  style="position:absolute;left:0">' +
      "</div>" +
      ...
      '<div class="col-md-12">' +
      '<div class="row rightPanelRow">' +
      '<div id="" class="col-md-2 centerIcon">' +
      '<label class="customCheckBox customCheckBoxLightPurple" >' +
      '<input class="form-check-input" type="checkbox" id="allocations" onclick=addAndRemoveLayer(allocations,"allocations")  value="">' +
      '<span class="checkmark checkmark-margin checkmarkLeftUpper vertical-center-icon-checkmark" id="checkmarkNoAllocations" >' +
      '<i class="fas fa-check" id="fa-checkmarkNoAllocations"></i></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="allocations" id="vc4">' +
      ...
      '<div class="col-md-12" >' + //border-bottom: 1px solid rgba(0,0,0,.125);
      '<div class="row rightPanelRow">' +
      '<div id="violation14" class="col-md-2 centerIcon">' +
      '<label class="customCheckBox customCheckBoxDarkBrown" >' +
      '<input class="form-check-input" type="checkbox" id="violation4" onclick=addAndRemoveLayer(violation4,"violation4")  value="">' +
      '<span class="checkmark checkmark-margin checkmarkLeftUpper vertical-center-icon-checkmark" id="checkmarkNoViolation4" >' +
      '<i class="fas fa-check" id="fa-checkmarkNoViolation4"></i></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class4" id="vc4">' +
      language.violation_class4 +
      "</p>" +
      "</div>" +
      "</div>" +
      ...
      '<div class="col-md-12">' +
      '<div class="row rightPanelRow">' +
      '<div id="violation15" class="col-md-2 centerIcon">' +
      '<label class="customCheckBox customCheckBoxGray" >' +
      '<input class="form-check-input" type="checkbox" id="violation5" onclick=addAndRemoveLayer(violation5,"violation5")  value="">' +
      '<span class="checkmark checkmark-margin checkmarkLeftUpper vertical-center-icon-checkmark" id="checkmarkNoViolation5" >' +
      '<i class="fas fa-check" id="fa-checkmarkNoViolation5"></i></span>' +
      "</div>" +
      '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class5" id="vc4">' +
      language.violation_class5 +
      "</p>" +
      "</div>" +
      "</div>" +
      "</div>" +
...
function toggle_layer(lyr_key, is_active) {
  if (
    lyr_key ==
      "tbl_herding_outpost,tbl_seizure_ab,tbl_babachy_israeli,area_controlled_by_settlers,wzo_allocations,outposts_pre_2022,outposts_post_2022,,tbl_settler_cattle_enclosures" ||
...
$(document).on("click", "#en", function (e) {
  window.location.href = "/herding/?lang=en";
});
$(document).on("click", "#arb", function (e) {
  window.location.href = "/herding/?lang=arb";
});
$(document).on("click", "#heb", function (e) {
  window.location.href = "/herding/?lang=heb";
});
...
$(document).on("input change", ".range-slider__range", function (e) {
  ...
  if (lyr_config.actual_lyr instanceof L.MarkerClusterGroup) {
  } else {
...
$(document).ready(function () {
  ...
  setTimeout(function () {
    $("#demolitions1").append(
      '<div style="margin-top: -12px;position: absolute;font-size:20px;" class="tooltip-custom text-justify" title="' +
    ...
    $("#area_b_training1").append(
      '<div style="margin-top: -12px;position: absolute;font-size:20px;" class="tooltip-custom2 text-justify" title="' +
    ...
    $("#security_orders1").append(
      '<div style="margin-top: -12px;position: absolute;font-size:20px;" class="tooltip-custom3 text-justify" title="' +
    ...
    $("#babachy_israeli1").append(
      '<div style="margin-top: -12px;position: absolute;font-size:20px;" class="tooltip-custom6 text-justify" title="' +
        language.demolition_settlers +
        '<span class=\'close6\'></span>" style="width: 100%; margin: 0 auto;margin-left:110px;margin-top:-30px;"><i class="infoCss" id="tooltip-custom6" style="cursor: pointer"><img src="assets/img/info.png"></i></div>'
    );
    ...
    $(document).on("click", "#tooltip-custom", function () {
      ...
      var snapcode =
        "<div style='' class='custom-leftside-bar'><span data-translate='Polygons' class='" +
        language_type +
        "-custom-rightside-bar-title'>" +
        language.Polygons +
        "</span></div>";
    ...
    $(document).on("click", "#tooltip-custom7", function () {
      ...
      tooltipTextDirection(language_type);
      var snapcode =
        "<div style='' class='custom-rightside-bar'><span data-translate='Layers' class='" +
        language_type +
        "-custom-rightside-bar-title'>" +
        language.Layers +
        "</span></div>";
...
function popuponthefly(fid, lat, lng) {
  ...
  $.ajax({
    url: "http://18.224.27.72/herding/kn_api/area_b_violations",
    type: "GET",
    success: function (res) {
      var rs = res;
      for (var i = 0; i < rs.features.length; i++) {
        if (rs.features[i].properties.fid == parseInt(fid)) {
          ...
          var str =
            ...
            "</h3>";
          $.ajax({
            url: "/herding/getimages.php?id=" + fid,
            type: "GET",
            success: function (res) {
              var images = JSON.parse(res);
              if (images.length > 0) {
...
$(document).ready(function () {
  $("body").click(function (e) {
    ...
    if (left_popup) {
      ...
      $(".container-fluid-title-div").addClass(
        language_type + "-container-fluid-title-div"
      );
