...
var server_url = "http://localhost/herding/";
...
var data_config_right = {
  ...
  area_b_violations: {
    ...
    url: "http://localhost/herding/kn_api/herding_outpost",
    geojson_options: {
  ...
  area_b_training: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_declared_state_land",
    /*geojson_options: {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    pane: "right_layers",
  ...
  security_orders: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_tabu_state_land",
    /*geojson_options: {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    pane: "right_layers",
  ...
  area_b_demolitions: {
    ...
    trans_name: "AreaB",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_firing_zone",
  ...
  tbl_expropriation_orders_ab: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/expropriation_orders_ab",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_expropriation_orders: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/expropriation_orders",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_no_construction_order: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_nature_reserve",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  tbl_no_construction_order_not_ab: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/no_construction_order_not_ab",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
  ...
  area_controlled_by_settlers: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_hearding_farms_zones",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        // layer.bindPopup(
  ...
  area_controlled_by_settlers2025: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_area_controlled_settlers_2022",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        // layer.bindPopup(
  ...
  wzo_allocations: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_wzo_allocations",
    geojson_options: {
      pane: "right_layers",
      onEachFeature: function (feature, layer) {
        // layer.bindPopup(
  ...
  outposts_post_2022: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/herding_outpost_post_2022",
    geojson_options: {
      pane: "right_layers",
      pointToLayer: function (feature, latlng) {
  ...
  tbl_palestinian_herding_communities: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_palestinian_herding_communities",
    geojson_options: {
      onEachFeature: function (feature, layer) {},
      pointToLayer: function (feature, latlng) {
  ...
  tbl_settler_cattle_enclosures: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/tbl_settler_cattle_enclosures",
    geojson_options: {
      onEachFeature: function (feature, layer) {},
      pointToLayer: function (feature, latlng) {
  ...
  tbl_babachy_israeli: {
    ...
    trans_name: "Areas",
    type: "geojson_vg_new",
    url: "http://localhost/herding/kn_api/babachy_israeli",
    geojson_options: {
      onEachFeature: function (feature, layer) {
        layer.bindPopup(
...
function load_poi_cluster_layer_new(
  ...
  console.log("LOAD POIs", lyr_config.url);
  $.ajax({
    url: lyr_config.url,
    type: "GET",
    success: function (res) {
            ...
            $.ajax({
              ...
              success: function (res) {
                ...
                str =
                  ...
                  '<div class="fb-share-button" data-href="http://localhost/herding/index.php?' +
                  "lat=" +
                  layer._latlng.lat +
                  "&lng=" +
                  layer._latlng.lng +
                  "&fid=" +
                  properties.photoid +
                  '" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://localhost/herding/index.php?' +
                  "lat=" +
                  layer._latlng.lat +
                  "&lng=" +
                  layer._latlng.lng +
                ...
                var twitter_url = encodeURIComponent(
                  "http://localhost/herding/index.php?" +
                    "lat=" +
                    layer._latlng.lat +
                    "&lng=" +
                    layer._latlng.lng +
                ...
                // '<tr><td>Affected Palestinian Community</td><td>N/A</td></tr>' +
                // '<tr><td>URL</td><td>http://localhost/index.php?lat='+layer._latlng.lat+'&lng='+layer._latlng.lng+'&fid='+properties.fid+'</td></tr>' +
                // '</table>';
                // </div>';
            ...
            $.ajax({
              ...
              success: function (res) {
                ...
                var html =
                  ...
                  '<div  class="popuptwittersubDiv">' +
                  '<div class="col-md-12">' +
                  '<div class="fb-share-button leaflet-popup-content-fb" data-href="http://localhost/herding/index.php?' +
                  "lat=" +
                  layer._latlng.lat +
                  "&lng=" +
                  layer._latlng.lng +
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                str =
                                    ...
                                    '<div class="fb-share-button" data-href="http://localhost/kn/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                                    "&fid=" +
                                    properties.fid +
                                    '" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://localhost/kn/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
...
function generate_layer_html(lyr_config, lyr_key, lyr) {
  ...
  if (
    ...
    if (lyr_key == "tbl_herding_outpost") {
      ...
      html =
        '<div data-lyr-key="tbl_herding_outpost,tbl_seizure_ab" class="layer-box mb-2 d-flex flex-column align-items-center justify-content-between"><div class="d-flex justify-content-between w-100"><div class="layer-box-right d-flex align-items-center"><span class="layer-toggler active"></span><span class="layer-title" data-translate="' +
    ...
    var html =
      ...
      '<div class="row rightPanelRow">' +
      '<div id="violation12" class="col-md-3" style="position:absolute;right:0">' +
      ...
      '<label class="customCheckBox customCheckBoxDarkBrown" style="">' +
      '<input class="form-check-input" type="checkbox" id="violation4" onclick=addAndRemoveLayer(violation4,"violation4")  value="">' +
      '<span class="checkmark checkmark-margin checkmarkLeftUpper vertical-center-icon-checkmark" id="checkmarkNoViolation4" style="">' +
      ...
      '<label class="customCheckBox customCheckBoxGray" style="">' +
      '<input class="form-check-input" type="checkbox" id="violation5" onclick=addAndRemoveLayer(violation5,"violation5")  value="">' +
      '<span class="checkmark checkmark-margin checkmarkLeftUpper vertical-center-icon-checkmark" id="checkmarkNoViolation5" style="">' +
      ...
      '<div class="col-md-12">' +
      '<div class="row rightPanelRow">' +
      '<div id="allocations1" class="col-md-2 centerIcon">' +
      '<label class="customCheckBox customCheckBoxPurple" style="">' +
      '<input class="form-check-input" type="checkbox" id="allocations" onclick=addAndRemoveLayer(allocations,"allocations")  value="">' +
      '<span class="checkmark checkmark-margin checkmarkLeftUpper vertical-center-icon-checkmark" id="checkmarkNoAllocations" style="">' +
...
function popuponthefly(fid, lat, lng) {
  ...
  $.ajax({
    url: "http://localhost/herding/kn_api/area_b_violations",
    type: "GET",
    success: function (res) {
      var rs = res;
