...
var data_config_right = {
    ...
    area_b_violations: {
        ...
        url: "http://3.17.36.216/herding/kn_api/herding_outpost",
        geojson_options: {
            ...
            onEachFeature: function (feature, layer) {
                ...
                if (language_type == "en") {
                    ...
                    var year_established =
                        properties.year_established == null ? " " : properties.year_established;
            ...
            pointToLayer: function (feature, latlng) {
                ...
                if (language_type == "en") {
                    ...
                    if (feature.properties.classfication_hebrew == "מאחז בת - שלוחה של מאחז") {
                        return L.marker(latlng, {
                            icon: L.icon({
                                iconUrl: "assets/img/r-lyr-3.png",
                                iconSize: [24, 28],
                        ...
                        feature.properties.classfication_hebrew == "מאחזי רועים"
                    ) {
                        return L.marker(latlng, {
                            icon: L.icon({
                                iconUrl: "assets/img/r-lyr-1.png",
                        ...
                        feature.properties.classfication_hebrew == "מאחזי חוות"
                    ) {
                        return L.marker(latlng, {
                            icon: L.icon({
                                iconUrl: "assets/img/r-lyr-2.png",
    ...
    area_b_training: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/tbl_declared_state_land",
        /*geojson_options: {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    pane: "right_layers",
    ...
    security_orders: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/tbl_tabu_state_land",
        /*geojson_options: {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    pane: "right_layers",
    ...
    area_b_demolitions: {
        ...
        trans_name: "AreaB",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/tbl_firing_zone",
    ...
    tbl_expropriation_orders_ab: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/expropriation_orders_ab",
        geojson_options: {
            pane: "right_layers",
            onEachFeature: function (feature, layer) {
                layer.bindPopup(
    ...
    tbl_expropriation_orders: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/expropriation_orders",
        geojson_options: {
            pane: "right_layers",
            onEachFeature: function (feature, layer) {
                layer.bindPopup(
    ...
    tbl_no_construction_order: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/tbl_nature_reserve",
        geojson_options: {
            pane: "right_layers",
            onEachFeature: function (feature, layer) {
                layer.bindPopup(
    ...
    tbl_no_construction_order_not_ab: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/no_construction_order_not_ab",
        geojson_options: {
            pane: "right_layers",
            onEachFeature: function (feature, layer) {
                layer.bindPopup(
...
//                layer.addTo(
            ...
            pointToLayer: function (feature, latlng) {
                ...
                if (language_type == "en") {
                    if (
                        feature.properties.classfication_english == "Herding Outpost 1"
                    ) {
                        return L.marker(latlng, {
                            icon: L.icon({
                                iconUrl: "assets/img/r-lyr-3.png",
    ...
    area_controlled_by_settlers: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/tbl_hearding_farms_zones",
        geojson_options: {
            pane: "right_layers",
            onEachFeature: function (feature, layer) {
                // layer.bindPopup(
    ...
    tbl_babachy_israeli: {
        ...
        trans_name: "Areas",
        type: "geojson_vg_new",
        url: "http://3.17.36.216/herding/kn_api/babachy_israeli",
        geojson_options: {
            onEachFeature: function (feature, layer) {
                layer.bindPopup(
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (lyr_key == "area_controlled_by_settlers") {
                area_controlled_by_settlers = L.geoJSON(res, lyr_config.geojson_options);
            ...
            violation1 = L.geoJson(res, {
                onEachFeature: function (feature, layer) {
                    ...
                    if (language_type == "en") {
                        ...
                        var titt_eng = properties.titt_eng == null ? " " : properties.titt_eng;
                        var desc_eng = properties.desc_eng == null ? " " : properties.desc_eng;
                        var str =
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                str =
                                    ...
                                    '<div class="fb-share-button" data-href="http://3.17.36.216/herding/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                                    "&fid=" +
                                    properties.photoid +
                                    '" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://3.17.36.216/herding/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                                ...
                                var twitter_url = encodeURIComponent(
                                    "http://3.17.36.216/herding/index.php?" +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                    ...
                    if (language_type == "arb") {
                        ...
                        var titt_arb = properties.titt_arb == null ? " " : properties.titt_arb;
                        var desc_arb = properties.desc_arb == null ? " " : properties.desc_arb;
                        var year_established =
                            properties.year_established == null ? " " : properties.year_established;
                        var str =
                            '<div style="min-width: 300px;max-width: none;padding-bottom:0px;" class="container-fluid">' +
                    ...
                    if (language_type == "heb") {
                        ...
                        var titt_heb = properties.titt_heb == null ? " " : properties.titt_heb;
                        var desc_heb = properties.desc_heb == null ? " " : properties.desc_heb;
                        var year_established =
                            properties.year_established == null ? " " : properties.year_established;
                        var str =
                            '<div style="min-width: 300px;max-width: none;padding-bottom:0px;" class="container-fluid">' +
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                var html =
                                    ...
                                    '<div  class="popuptwittersubDiv">' +
                                    '<div class="col-md-12">' +
                                    '<div class="fb-share-button leaflet-popup-content-fb" data-href="http://3.17.36.216/herding/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                str =
                                    ...
                                    '<div class="fb-share-button" data-href="http://3.17.36.216/kn/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
                                    "&fid=" +
                                    properties.fid +
                                    '" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://3.17.36.216/kn/index.php?' +
                                    "lat=" +
                                    layer._latlng.lat +
                                    "&lng=" +
                                    layer._latlng.lng +
...
function generate_layer_html(lyr_config, lyr_key, lyr) {
    ...
    if (lyr_key == "tbl_herding_outpost" ||lyr_key == "area_controlled_by_settlers" || lyr_key == "tbl_seizure_ab" || lyr_key == "tbl_babachy_israeli") {
        if (lyr_key == "tbl_herding_outpost") {
        ...
        var html =
            ...
            '<div class="row rightPanelRow" style="">' +
            '<div id="violation12" class="col-md-3" style="position:absolute;right:0">' +
            '<img src="assets/img/r-lyr-1.png" width="30px" height="30px" style="position: absolute;">' +
            ...
            "</div>" +
            '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class2" id="vc2">' +
            language.violation_class2 +
            "</p>" +
            "</div>" +
            ...
            '<div class="col-md-12" style="">' + //border-bottom: 1px solid rgba(0,0,0,.125);
            '<div class="row rightPanelRow" style="">' +
            '<div id="violation13" class="col-md-3" style="position:absolute;right:0">' +
            '<img src="assets/img/r-lyr-2.png" width="20px" height="20x" style="position: absolute;">' +
            ...
            "</div>" +
            '<div class="col-md-9 rightPanelFont"><p data-translate="violation_class3" id="vc3">' +
            language.violation_class3 +
            "</p></div>" +
            ...
            '<div class="col-md-12" style="">' + //border-bottom: 1px solid rgba(0,0,0,.125);
            '<div class="row rightPanelRow" style="">' +
            '<div id="violation11" class="col-md-3" style="position:absolute;right:0">' +
            '<img src="assets/img/r-lyr-3.png" width="30px" height="30px" style="position: absolute;">' +
            '<label class="customCheckBoxRightDoNot customCheckBoxRight"><input class="form-check-input" onclick=addAndRemoveLayer(violation1,"violation1") type="checkbox" id="violation1"  value=""><span class="checkmarkNo" id="checkmarkNoViolation1" style="top: 14px;"></span>' +
            "</label></div>" +
            '<div  class="col-md-9 rightPanelFont">' +
            ...
            '<div id="violation14" class="col-md-2" style="position:absolute;right:0;padding: 10px 22px;">' +
            ...
            '<span class="checkmark checkmarkLeftUpper" id="checkmarkNoViolation4" style="">' +
            ...
            language.violation_class4 +
            "</p></div>" +
            '<div id="" class="col-md-2"  style="position:absolute;left:0">' +
            "</div>" +
            "</div>" +
            "</div>" +
            "</div>" +
...
function toggle_layer(lyr_key, is_active) {
    if (
        lyr_key == "tbl_herding_outpost,tbl_seizure_ab,tbl_babachy_israeli,area_controlled_by_settlers" ||
...
function popuponthefly(fid, lat, lng) {
    ...
    $.ajax({
        url: "http://3.17.36.216/herding/kn_api/area_b_violations",
        type: "GET",
        success: function (res) {
            var rs = res;
